...
function SuperMacroOptionsFrame_OnShow()
  for k, v in pairs(SuperMacroOptionsFrameCheckButtons) do
	...
	for k, v in pairs(SuperMacroOptionsFrameColorSwatches) do
...
if ( GameMenuButtonSuperMacro ) then
	GameMenu_AddButton(GameMenuButtonSuperMacro);
end
-- end
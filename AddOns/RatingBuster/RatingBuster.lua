...
LastUpdate: $Date: 2008-10-05 15:47:48 +0000 (Sun, 05 Oct 2008) $
]]
...
RatingBuster.version = "1.3.8 (r"..gsub("$Revision: 170 $", "(%d+)", "%1")..")"
RatingBuster.date = gsub("$Date: 2008-10-05 15:47:48 +0000 (Sun, 05 Oct 2008) $", "^.-(%d%d%d%d%-%d%d%-%d%d).-$", "%1")
...
local summaryCalcData = {
	...
	-- Parry Chance - PARRY_RATING, DEFENSE_RATING
	{
		...
		func = function(sum, statDataType)
			...
			return StatLogic:GetEffectFromRating(parryRating, "PARRY_RATING", calcLevel)
				+ StatLogic:GetEffectFromRating((sum["DEFENSE_RATING"] or 0), "DEFENSE_RATING", calcLevel) * 0.04
		end,
		ispercent = true,
	},

...
Last Update: $Date: 2008-10-11 14:22:07 +0000 (Sat, 11 Oct 2008) $
Website:
Documentation:
...
PatternLocale.koKR = {
	...
	["StatIDLookup"] = {
		...
		["방어구 관통도가 증가합니다"] = {"ARMOR_PENETRATION_RATING"},
		["Increases your armor penetration rating"] = {"ARMOR_PENETRATION_RATING"}, -- ID:43178
		-- Exclude
		["초"] = false,
		["to"] = false,
...
DisplayLocale.koKR = {
	...
	["StatIDToName"] = {
		...
		["RANGED_DMG"] = {"원거리 무기 "..DAMAGE, "Ranged Dmg"}, -- DAMAGE = "Damage"
		...
		["ARMOR_PENETRATION_RATING"] = {"방어구 관통".." "..RATING, "ArP".." "..RATING},
...
if toc >= 30000 then
BaseDodge = {
	3.4636, 3.2685, -5.4500, -0.5900, 3.1830, 0.7580, 1.6750, 3.4575, 2.0350, 4.951,
	--["WARRIOR"] =     3.4636,
	--["PALADIN"] =     3.2685,
	--["HUNTER"] =     -5.4500,
	--["ROGUE"] =      -0.5900,

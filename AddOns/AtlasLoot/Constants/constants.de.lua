...
--	["ItemID:"] = true,
	...
	-- Cassis Edit
	["Drop from Nexus Stalker"] = "Drop von Nexuswandler",
	["Drop from Ethereal Priest"] = "Drop von Astraler Priester",
	["Avatar of the Martyred"] = "Avatar des Gemarterten",
	["Summoned during the boss fight"] = "Wird im Bosskampf beschworen",
	["Drop from Auchenai Monk"] = "Drop von Mönch der Auchenai",
	["Drop from Raging Skeleton"] = "Drop von Tobendes Skelett",
	["Drop from Sethekk Ravenguard"] = "Drop von Rabenwächter der Sethekk",
	["Drop from Time-Lost Shadowmage"] = "Drop von Zeitverlorener Schattenmagier",
	["Drop from Cabal Fanatic"] = "Drop von Fanatiker der Kabale",
	["First Fragment Guardian"] = "Wächter des ersten Teils",
	["Karazhan Pre-Quest"] = "Karazhan Vorquest",
	["Drop from Durnholde Rifleman"] = "Drop von Scharfschütze von Durnholde",
	["Thomas Yance"] = "Thomas Yance",
	["Merchant"] = "Händler",
	["Aged Dalaran Wizard"] = "Gealterter Hexer von Dalaran",
	["Drop from Coilfang Sorceress"] = "Drop von Zauberin des Echsenkessels",
	["Drop from Coilfang Oracle"] = "Drop von Orakel des Echsenkessels",
	["Second Fragment Guardian"] = "Wächter des zweiten Teils",
	["Drop from Shattered Hand Centurion"] = "Drop von Zenturio der Zerschmetterten Hand",
	["Drop from Phantom Attendant"] = "Drop von Phantomknecht",
	["Drop from Phantom Valet"] = "Drop von Phantomdiener",
	["Drop from Phantom Stagehand"] = "Drop von Phantombühnenarbeiter",
	["Drop from Sunseeker Astromage"] = "Drop von Astromagier der Sonnensucher",
	["Gatewatcher Gyro-Kill"] = "Torwächter Gyrotod",
	["Key Guardian"] = "Schlüsselbewahrer",
	["Gatewatcher Iron-Hand"] = "Torwächter Eisenhand",
	["Drop from Sunseeker Botanist"] = "Drop von Botaniker der Sonnensucher",
	["Drop from Unchained Doombringer"] = "Drop von Entfesselter Verdammnisbringer",
	["Drop from Eredar Deathbringer"] = "Drop von Todesbringer der Eredar",
	["Drop from Gargantuan Abyssal"] = "Drop von Riesengroßer Abyss",
	["Drop from Arcatraz Sentinel"] = "Drop von Schildwache der Arkatraz",
	["Third Fragment Guardian"] = "Wächter des dritten Teils",
	["Shadow Labyrinth"] = "Schattenlabyrinth",
	["The Underbog (Heroic)"] = "Der Tiefensumpf (Heroisch)",
	["The Scryers"] = "Die Seher",
	["The Slave Pens (Heroic)"] = "Die Sklavenunterkünfte (Heroisch)",
	...
	["Caverns of Time 1 (Heroic)"] = "Höhlen der Zeit 1 (Heroisch)",
	["Warlock (Destruction)"] = "Hexenmeister (Zerstörung)",
	["Best-in-Slot Gear"] = "Best-in-Slot Ausrüstung",
	["Pre-Karazhan"] = "Vor-Karazhan",
	["Druid (Alliance)"] = "Druide (Allianz)",
	["Blue PvP Sets"] = "Blaue PvP Sets",
	...
	["Paladin (Alliance)"] = "Paladin (Allianz)",
	...
	["Blue PvP Weapons (Page 1)"] = "Blaue PvP Waffen (Seite 1)",
	["Blue PvP Weapons (Page 2)"] = "Blaue PvP Waffen (Seite 2)",
	["Optional"] = "Optional",
	["World Boss Loot"] = "Weltboss Loot",
	["Paladin (Horde)"] = "Paladin (Horde)",
	["Priest"] = "Priester",
	...
	["Shaman (Alliance)"] = "Schamane (Allianz)",
	["Shaman (Horde)"] = "Schamane (Horde)",
	["Warlock"] = "Hexenmeister",
	["Warrior"] = "Krieger",
	["Season 1 Arena Weapons"] = "Saison 1 Arena Waffen",
	["PvP Weapons (Level 60)"] = "PvP Waffen (Level 60)",
	["Warlock (Affliction)"] = "Hexenmeister (Gebrechen)",
	["Mana-Tomb (Heroic)"] = "Managruft (Heroisch)",
	["Auchenai Crypts (Heroic)"] = "Auchenaikrypta (Heroisch)",
	["Blood Furnace (Heroic)"] = "Blutkessel (Heroisch)",
	["Alternative Items"] = "Alternative Items",
	["Caverns of Time 2"] = "Höhlen der Zeit 2",
	["Doomwalker"] = "Verdammniswandler",
	["Doom Lord Kazzak"] = "Verdammnislord Kazzak",
	["The Steamvault"] = "Die Dampfkammer",
	["The Steamvault (Heroic)"] = "Die Dampfkammer (Heroisch)",
	["The Botanica (Heroic)"] = "Die Botanika (Heroisch)",
	["Warrior (Tank)"] = "Krieger (Tank)",
	["The Mechanar"] = "Die Mechanar",
	["The Mechanar (Heroic)"] = "Die Mechanar (Heroisch)",
	["Heal Druid"] = "Heil-Druide",
	["Arena Season 1"] = "Arena Saison 1",
	["Serpentshrine Cavern"] = "Höhle des Schlangenschreins",
	["The Violet Eye"] = "Das Violette Auge",
	["The Botanica"] = "Die Botanika",
	["Innervate Staff"] = "Anregen Stab",
	["Increases Innervate's Mana Regen"] = "Erhöht Mana-Regen von Anregen",
	["The Mag'har"] = "Die Mag'har",
	["The Consortium"] = "Das Konsortium",
	["Warrior (DPS)"] = "Krieger (DPS)",
	["Caverns of Time 2 (Heroic)"] = "Höhlen der Zeit 2 (Heroisch)",
	["Fury Spec Weapons"] = "Furor Spec Waffen",
	["Priest (Heal)"] = "Priester (Heilung)",
	["Sethekk Halls (Heroic)"] = "Sethekkhallen (Heroisch)",
	["Horde only"] = "Nur Horde",
	["Mage (Fire)"] = "Magier (Feuer)",
	["Paladin (Heal)"] = "Paladin (Heilung)",
	["Priest (DPS)"] = "Priester (DPS)",
	["Alliance only"] = "Nur Allianz",
	["Druid (Heal)"] = "Druide (Heilung)",
	["The Shattered Halls (Heroic)"] = "Die zerschmetterten Hallen (Heroisch)",
	["Druid (Tank)"] = "Druide (Tank)",
	["Druid (DPS Feral)"] = "Druide (DPS Feral)",
	["Druid (DPS Balance)"] = "Druide (DPS Gleichgewicht)",
	["Shaman (DPS Elemental)"] = "Schamane (DPS Elementar)",
	["Shaman (DPS Enhancer)"] = "Schamane (DPS Verstärker)",
	["Shaman (Heal)"] = "Schamane (Heilung)",
	["1h + Shield"] = "1h + Schild",
	["For Defensive Stance"] = "Für Verteidigungshaltung",
	["Pre-T5"] = "Vor-T5",
	["Gruul's Lair"] = "Gruul's Unterschlupf",

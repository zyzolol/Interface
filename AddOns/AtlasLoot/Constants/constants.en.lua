...
AL:RegisterTranslations("enUS", function() return {
	...
	-- Cassis Edit
    ["Drop from Nexus Stalker"] = true,
    ["Drop from Ethereal Priest"] = true,
    ["Avatar of the Martyred"] = true,
    ["Summoned during the boss fight"] = true,
    ["Drop from Auchenai Monk"] = true,
    ["Drop from Raging Skeleton"] = true,
    ["Drop from Sethekk Ravenguard"] = true,
    ["Drop from Time-Lost Shadowmage"] = true,
    ["Drop from Cabal Fanatic"] = true,
    ["First Fragment Guardian"] = true,
    ["Karazhan Pre-Quest"] = true,
    ["Drop from Durnholde Rifleman"] = true,
    ["Thomas Yance"] = true,
    ["Merchant"] = true,
    ["Aged Dalaran Wizard"] = true,
    ["Drop from Coilfang Sorceress"] = true,
    ["Drop from Coilfang Oracle"] = true,
    ["Second Fragment Guardian"] = true,
    ["Drop from Shattered Hand Centurion"] = true,
    ["Drop from Phantom Attendant"] = true,
    ["Drop from Phantom Valet"] = true,
    ["Drop from Phantom Stagehand"] = true,
    ["Drop from Sunseeker Astromage"] = true,
    ["Gatewatcher Gyro-Kill"] = true,
    ["Key Guardian"] = true,
    ["Gatewatcher Iron-Hand"] = true,
    ["Drop from Sunseeker Botanist"] = true,
    ["Drop from Unchained Doombringer"] = true,
    ["Drop from Eredar Deathbringer"] = true,
    ["Drop from Gargantuan Abyssal"] = true,
    ["Drop from Arcatraz Sentinel"] = true,
    ["Third Fragment Guardian"] = true,
    ["GM Items"] = true,
    ["Season 1 Arena Weapons"] = true,
    ["Season 2 Arena Weapons"] = true,
    ["Season 3 Arena Weapons"] = true,
    ["Season 4 Arena Weapons"] = true,
    ["Shadow Labyrinth"] = true,
    ["The Underbog (Heroic)"] = true,
    ["The Scryers"] = true,
    ["The Slave Pens (Heroic)"] = true,
    ["Hellfire Ramparts (Heroic)"] = true,
    ["The Arcatraz"] = true,
    ["The Shattered Halls"] = true,
    ["Caverns of Time 1 (Heroic)"] = true,
    ["Warlock (Destruction)"] = true,
    ["Best-in-Slot Gear"] = true,
    ["Pre-Karazhan"] = true,
    ["Druid (Alliance)"] = true,
    ["Blue PvP Sets"] = true,
    ["Grand Marshal's Sanctuary"] = true,
    ["Grand Marshal's Refuge"] = true,
    ["Grand Marshal's Vestments"] = true,
    ["Grand Marshal's Wildhide"] = true,
    ["Druid (Horde)"] = true,
    ["High Warlord's Sanctuary"] = true,
    ["High Warlord's Refuge"] = true,
    ["High Warlord's Wildhide"] = true,
    ["Hunter"] = true,
    ["Grand Marshal's Pursuit"] = true,
    ["High Warlord's Pursuit"] = true,
    ["Mage"] = true,
    ["Grand Marshal's Regalia"] = true,
    ["High Warlord's Regalia"] = true,
    ["Paladin (Alliance)"] = true,
    ["Grand Marshal's Aegis"] = true,
    ["Grand Marshal's Redemption"] = true,
    ["Grand Marshal's Vindication"] = true,
    ["Blue PvP Weapons (Page 1)"] = true,
    ["Blue PvP Weapons (Page 2)"] = true,
    ["Optional"] = true,
    ["World Boss Loot"] = true,
    ["Paladin (Horde)"] = true,
    ["Priest"] = true,
    ["High Warlord's Aegis"] = true,
    ["High Warlord's Redemption"] = true,
    ["High Warlord's Vindication"] = true,
    ["Grand Marshal's Investiture"] = true,
    ["Grand Marshal's Raiment"] = true,
    ["High Warlord's Investiture"] = true,
    ["High Warlord's Raiment"] = true,
    ["Rogue"] = true,
    ["Grand Marshal's Vestments"] = true,
    ["High Warlord's Vestments"] = true,
    ["Grand Marshal's Earthshaker"] = true,
    ["Grand Marshal's Thunderfist"] = true,
    ["Grand Marshal's Wartide"] = true,
    ["High Warlord's Earthshaker"] = true,
    ["High Warlord's Thunderfist"] = true,
    ["High Warlord's Wartide"] = true,
    ["Grand Marshal's Dreadgear"] = true,
    ["High Warlord's Dreadgear"] = true,
    ["Grand Marshal's Battlegear"] = true,
    ["High Warlord's Battlegear"] = true,
    ["Shaman (Alliance)"] = true,
    ["Shaman (Horde)"] = true,
    ["Warlock"] = true,
    ["Warrior"] = true,
    ["Warlock (Affliction)"] = true,
    ["Mana-Tomb (Heroic)"] = true,
    ["Auchenai Crypts (Heroic)"] = true,
    ["Blood Furnace (Heroic)"] = true,
    ["Alternative Items"] = true,
    ["Caverns of Time 2"] = true,
    ["Doomwalker"] = true,
    ["Doom Lord Kazzak"] = true,
    ["The Steamvault"] = true,
    ["The Steamvault (Heroic)"] = true,
    ["The Botanica (Heroic)"] = true,
    ["Warrior (Tank)"] = true,
    ["The Mechanar"] = true,
    ["The Mechanar (Heroic)"] = true,
    ["Heal Druid"] = true,
    ["Arena Season 1"] = true,
    ["Serpentshrine Cavern"] = true,
	["The Violet Eye"] = true,
    ["The Botanica"] = true,
    ["Innervate Staff"] = true,
    ["Increases Innervate's Mana Regen"] = true,
    ["Kurenai"] = true,
    ["The Mag'har"] = true,
    ["The Consortium"] = true,
    ["Warrior (DPS)"] = true,
    ["Caverns of Time 2 (Heroic)"] = true,
    ["Fury Spec Weapons"] = true,
    ["Priest (Heal)"] = true,
    ["Sethekk Halls (Heroic)"] = true,
    ["Horde only"] = true,
    ["Mage (Fire)"] = true,
    ["Paladin (AOE Tank)"] = true,
    ["Paladin (Heal)"] = true,
    ["Paladin (DPS)"] = true,
    ["Priest (DPS)"] = true,
    ["Alliance only"] = true,
    ["Druid (Heal)"] = true,
    ["The Shattered Halls (Heroic)"] = true,
    ["Druid (Tank)"] = true,
    ["Druid (DPS Feral)"] = true,
    ["Druid (DPS Balance)"] = true,
    ["Shaman (DPS Elemental)"] = true,
    ["Shaman (DPS Enhancer)"] = true,
    ["Shaman (Heal)"] = true,
    ["1h + Shield"] = true,
    ["For Defensive Stance"] = true,
    ["Magtheridon"] = true,
    ["Pre-T5"] = true,
    ["Gruul's Lair"] = true,

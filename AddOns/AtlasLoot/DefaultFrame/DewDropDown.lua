...
AtlasLoot_DewDropDown = {
	...
	[6] = {
		[AL["Best-in-Slot Gear"]] = {
			[1] = { 
				{ AL["Pre-Karazhan"], "BiSPreKara", "Submenu" },
			},
			[2] = { 
				{ AL["Pre-T5"], "BiSPreT5", "Submenu" },
			},
			[3] = { 
				{ AL["Arena Season 1"], "BiSSeason1", "Submenu" },
			},
		},
	},
	[7] = {
...
AtlasLoot_DewDropDown_SubTables = {
	...
	["ArenaPvPRewards"] = {
		...
		{ AL["Season 1 Arena Weapons"], "ArenaWeapons1" },
	},
	["Arena2PvPRewards"] = {
		...
		{ AL["Season 2 Arena Weapons"], "Arena2Weapons1" },
	},
	["Arena3PvPRewards"] = {
		...
		{ AL["Season 3 Arena Weapons"], "Arena3Weapons1" },
	},
	["Arena4PvPRewards"] = {
		...
		{ AL["Season 4 Arena Weapons"], "Arena4Weapons1" },
	},
	["AVRewards"] = {
	...
	["PvPLvl70Rewards"] = {
		{ AL["Druid (Alliance)"], "PvP70DruidAlli" },
		{ AL["Druid (Horde)"], "PvP70DruidHorde" },
		{ AL["Hunter"], "PvP70Hunter" },
		{ AL["Mage"], "PvP70Mage" },
		{ AL["Paladin (Alliance)"], "PvP70PaladinAlli" },
		{ AL["Paladin (Horde)"], "PvP70PaladinHorde" },
		{ AL["Priest"], "PvP70Priest" },
		{ AL["Rogue"], "PvP70Rogue" },
		{ AL["Shaman (Alliance)"], "PvP70ShamanAlli" },
		{ AL["Shaman (Horde)"], "PvP70ShamanHorde" },
		{ AL["Warlock"], "PvP70Warlock" },
		{ AL["Warrior"], "PvP70Warrior" },
		{ AL["Blue PvP Weapons (Page 1)"], "PvP70Weapons1" },
		{ AL["Blue PvP Weapons (Page 2)"], "PvP70Weapons2" },
	...
	["BiSPreKara"] = {
		{ AL["Mage (Fire)"], "BiSPreKaraFireMage" },
		{ AL["Warlock (Affliction)"], "BiSPreKaraAffliLock" },
		{ AL["Warlock (Destruction)"], "BiSPreKaraDestroLock" },
		{ AL["Priest (Heal)"], "BiSPreKaraHealPriest" },
		{ AL["Priest (DPS)"], "BiSPreKaraShadowPriest" },
		{ AL["Druid (DPS Balance)"], "BiSPreKaraDPSBalanceDruid" },
		{ AL["Druid (DPS Feral)"], "BiSPreKaraDPSFeralDruid" },
		{ AL["Druid (Tank)"], "BiSPreKaraTankDruid" },
		{ AL["Druid (Heal)"], "BiSPreKaraHealDruid" },
		{ AL["Rogue"], "BiSPreKaraRogue" },
		{ AL["Hunter"], "BiSPreKaraHunter" },
		{ AL["Shaman (DPS Elemental)"], "BiSPreKaraDPSEleShaman" },
		{ AL["Shaman (DPS Enhancer)"], "BiSPreKaraDPSEnhShaman" },
		{ AL["Shaman (Heal)"], "BiSPreKaraHealShaman" },
		{ AL["Warrior (DPS)"], "BiSPreKaraDPSWarrior" },
		{ AL["Warrior (Tank)"], "BiSPreKaraProtWarrior" },
		{ AL["Paladin (Heal)"], "BiSPreKaraHealPala" },
		{ AL["Paladin (AOE Tank)"], "BiSPreKaraAOEProtPala" },
		{ AL["Paladin (DPS)"], "BiSPreKaraRetPala" },
	},
	["BiSPreT5"] = {
		{ AL["Mage (Fire)"], "BiSPreT5FireMage" },
		{ AL["Warlock (Affliction)"], "BiSPreT5AffliLock" },
		{ AL["Warlock (Destruction)"], "BiSPreT5DestroLock" },
		{ AL["Priest (Heal)"], "BiSPreT5HealPriest" },
		{ AL["Priest (DPS)"], "BiSPreT5ShadowPriest" },
		{ AL["Druid (DPS Balance)"], "BiSPreT5DPSBalanceDruid" },
		{ AL["Druid (DPS Feral)"], "BiSPreT5DPSFeralDruid" },
		{ AL["Druid (Tank)"], "BiSPreT5TankDruid" },
		{ AL["Druid (Heal)"], "BiSPreT5HealDruid" },
		{ AL["Rogue"], "BiSPreT5Rogue" },
		{ AL["Hunter"], "BiSPreT5Hunter" },
		{ AL["Shaman (DPS Elemental)"], "BiSPreT5DPSEleShaman" },
		{ AL["Shaman (DPS Enhancer)"], "BiSPreT5DPSEnhShaman" },
		{ AL["Shaman (Heal)"], "BiSPreT5HealShaman" },
		{ AL["Warrior (DPS)"], "BiSPreT5DPSWarrior" },
		{ AL["Warrior (Tank)"], "BiSPreT5ProtWarrior" },
		{ AL["Paladin (Heal)"], "BiSPreT5HealPala" },
		{ AL["Paladin (AOE Tank)"], "BiSPreT5AOEProtPala" },
		{ AL["Paladin (DPS)"], "BiSPreT5RetPala" },
	},
	["BiSSeason1"] = {
		{ AL["Mage"], "BiSSeason1Mage" },
		{ AL["Warlock (Affliction)"], "BiSSeason1AffliWarlock" },
		{ AL["Priest (Heal)"], "BiSSeason1HealPriest" },
		{ AL["Priest (DPS)"], "BiSSeason1ShadowPriest" },
		{ AL["Druid (Heal)"], "BiSSeason1HealDruid" },
		{ AL["Rogue"], "BiSSeason1Rogue" },
		{ AL["Hunter"], "BiSSeason1Hunter" },
		{ AL["Shaman (DPS Elemental)"], "BiSSeason1EleShaman" },
		{ AL["Shaman (Heal)"], "BiSSeason1HealShaman" },
		{ AL["Warrior"], "BiSSeason1Warrior" },
		{ AL["Paladin (Heal)"], "BiSSeason1HealPaladin" },
		{ AL["Paladin (DPS)"], "BiSSeason1RetPaladin" },
	},
};

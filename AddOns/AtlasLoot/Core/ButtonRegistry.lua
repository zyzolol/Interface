...
AtlasLoot_ButtonRegistry = {
  ...
  --Burning Crusade Factions
	...
	["Aldor3"] = {
		Title = BabbleFaction["The Aldor"]..": "..BabbleFaction["Quest Rewards"]..""..BabbleFaction[""];
		Prev_Page = "Aldor2";
		Prev_Title = BabbleFaction["The Aldor"]..": "..BabbleFaction["Revered"].."/"..BabbleFaction["Exalted"];
		Back_Page = "REPMENU_SHATTRATH";
		Back_Title = AL["Factions - Shattrath City"];
		};
	["Ashtongue1"] = {
	...
	["Scryer3"] = {
		Title = BabbleFaction["The Scryers"]..": "..BabbleFaction["Quest Rewards"]..""..BabbleFaction[""];
		Prev_Page = "Scryer2";
		Prev_Title = BabbleFaction["The Scryers"]..": "..BabbleFaction["Revered"].."/"..BabbleFaction["Exalted"];
		Back_Page = "REPMENU_SHATTRATH";
		Back_Title = AL["Factions - Shattrath City"];
		};
	["Shatar1"] = {
...
--		};
	...
	--Blue PvP Sets
	["PvP70DruidAlli"] = {
		Title = AL["Druid (Alliance)"];
		Back_Page = "PvPLvl70Rewards";
		Back_Title = AL["Blue PvP Sets"];
		};
};
...
function AtlasLoot_FixText(text)
	...
	-- Cassis Edit
	text = gsub(text, "#cas1#", AL["Drop from Nexus Stalker"]);
	text = gsub(text, "#cas2#", AL["Drop from Ethereal Priest"]);
	text = gsub(text, "#cas3#", AL["Avatar of the Martyred"]);
	text = gsub(text, "#cas4#", AL["Summoned during the boss fight"]);
	text = gsub(text, "#cas5#", AL["Drop from Auchenai Monk"]);
	text = gsub(text, "#cas6#", AL["Drop from Raging Skeleton"]);
	text = gsub(text, "#cas7#", AL["Drop from Sethekk Ravenguard"]);
	text = gsub(text, "#cas8#", AL["Drop from Time-Lost Shadowmage"]);
	text = gsub(text, "#cas9#", AL["Drop from Cabal Fanatic"]);
	text = gsub(text, "#cas10#", AL["First Fragment Guardian"]);
	text = gsub(text, "#cas11#", AL["Karazhan Pre-Quest"]);
	text = gsub(text, "#cas12#", AL["Drop from Durnholde Rifleman"]);
	text = gsub(text, "#cas13#", AL["Thomas Yance"]);
	text = gsub(text, "#cas14#", AL["Merchant"]);
	text = gsub(text, "#cas15#", AL["Aged Dalaran Wizard"]);
	text = gsub(text, "#cas16#", AL["Drop from Coilfang Sorceress"]);
	text = gsub(text, "#cas17#", AL["Drop from Coilfang Oracle"]);
	text = gsub(text, "#cas18#", AL["Second Fragment Guardian"]);
	text = gsub(text, "#cas19#", AL["Drop from Shattered Hand Centurion"]);
	text = gsub(text, "#cas20#", AL["Drop from Phantom Attendant"]);
	text = gsub(text, "#cas21#", AL["Drop from Phantom Valet"]);
	text = gsub(text, "#cas22#", AL["Drop from Phantom Stagehand"]);
	text = gsub(text, "#cas23#", AL["Drop from Sunseeker Astromage"]);
	text = gsub(text, "#cas24#", AL["Gatewatcher Gyro-Kill"]);
	text = gsub(text, "#cas25#", AL["Key Guardian"]);
	text = gsub(text, "#cas26#", AL["Gatewatcher Iron-Hand"]);
	text = gsub(text, "#cas27#", AL["Drop from Sunseeker Botanist"]);
	text = gsub(text, "#cas28#", AL["Drop from Unchained Doombringer"]);
	text = gsub(text, "#cas29#", AL["Drop from Eredar Deathbringer"]);
	text = gsub(text, "#cas30#", AL["Drop from Gargantuan Abyssal"]);
	text = gsub(text, "#cas31#", AL["Drop from Arcatraz Sentinel"]);
	text = gsub(text, "#cas32#", AL["Third Fragment Guardian"]);
	text = gsub(text, "#cas33#", AL["Shadow Labyrinth"]);
	text = gsub(text, "#cas34#", AL["The Underbog (Heroic)"]);
	text = gsub(text, "#cas35#", AL["The Scryers"]);
	text = gsub(text, "#cas36#", AL["The Slave Pens (Heroic)"]);
	text = gsub(text, "#cas37#", AL["Hellfire Ramparts (Heroic)"]);
	text = gsub(text, "#cas38#", AL["The Arcatraz"]);
	text = gsub(text, "#cas39#", AL["The Shattered Halls"]);
	text = gsub(text, "#cas40#", AL["Caverns of Time 1 (Heroic)"]);
	text = gsub(text, "#cas41#", AL["Grand Marshal's Sanctuary"]);
	text = gsub(text, "#cas42#", AL["Grand Marshal's Refuge"]);
	text = gsub(text, "#cas43#", AL["Grand Marshal's Vestments"]);
	text = gsub(text, "#cas44#", AL["Grand Marshal's Wildhide"]);
	text = gsub(text, "#cas45#", AL["High Warlord's Sanctuary"]);
	text = gsub(text, "#cas46#", AL["High Warlord's Refuge"]);
	text = gsub(text, "#cas47#", AL["High Warlord's Wildhide"]);
	text = gsub(text, "#cas48#", AL["Grand Marshal's Pursuit"]);
	text = gsub(text, "#cas49#", AL["High Warlord's Pursuit"]);
	text = gsub(text, "#cas50#", AL["Grand Marshal's Regalia"]);
	text = gsub(text, "#cas51#", AL["High Warlord's Regalia"]);
	text = gsub(text, "#cas52#", AL["Grand Marshal's Aegis"]);
	text = gsub(text, "#cas53#", AL["Grand Marshal's Redemption"]);
	text = gsub(text, "#cas54#", AL["Grand Marshal's Vindication"]);
	text = gsub(text, "#cas55#", AL["Optional"]);
	text = gsub(text, "#cas56#", AL["World Boss Loot"]);
	text = gsub(text, "#cas57#", AL["High Warlord's Aegis"]);
	text = gsub(text, "#cas58#", AL["High Warlord's Redemption"]);
	text = gsub(text, "#cas59#", AL["High Warlord's Vindication"]);
	text = gsub(text, "#cas60#", AL["Grand Marshal's Investiture"]);
	text = gsub(text, "#cas61#", AL["Grand Marshal's Raiment"]);
	text = gsub(text, "#cas62#", AL["High Warlord's Investiture"]);
	text = gsub(text, "#cas63#", AL["High Warlord's Raiment"]);
	text = gsub(text, "#cas64#", AL["Grand Marshal's Vestments"]);
	text = gsub(text, "#cas65#", AL["High Warlord's Vestments"]);
	text = gsub(text, "#cas66#", AL["Grand Marshal's Earthshaker"]);
	text = gsub(text, "#cas67#", AL["Grand Marshal's Thunderfist"]);
	text = gsub(text, "#cas68#", AL["Grand Marshal's Wartide"]);
	text = gsub(text, "#cas69#", AL["High Warlord's Earthshaker"]);
	text = gsub(text, "#cas70#", AL["High Warlord's Thunderfist"]);
	text = gsub(text, "#cas71#", AL["High Warlord's Wartide"]);
	text = gsub(text, "#cas72#", AL["Grand Marshal's Dreadgear"]);
	text = gsub(text, "#cas73#", AL["High Warlord's Dreadgear"]);
	text = gsub(text, "#cas74#", AL["Grand Marshal's Battlegear"]);
	text = gsub(text, "#cas75#", AL["High Warlord's Battlegear"]);
	text = gsub(text, "#cas76#", AL["Mana-Tomb (Heroic)"]);
	text = gsub(text, "#cas77#", AL["Auchenai Crypts (Heroic)"]);
	text = gsub(text, "#cas78#", AL["Blood Furnace (Heroic)"]);
	text = gsub(text, "#cas79#", AL["Alternative Items"]);
	text = gsub(text, "#cas80#", AL["Caverns of Time 2"]);
	text = gsub(text, "#cas81#", AL["Doomwalker"]);
	text = gsub(text, "#cas82#", AL["Doom Lord Kazzak"]);
	text = gsub(text, "#cas83#", AL["The Steamvault"]);
	text = gsub(text, "#cas84#", AL["The Steamvault (Heroic)"]);
	text = gsub(text, "#cas85#", AL["The Botanica (Heroic)"]);
	text = gsub(text, "#cas86#", AL["The Mechanar"]);
	text = gsub(text, "#cas87#", AL["The Mechanar (Heroic)"]);
	text = gsub(text, "#cas88#", AL["Serpentshrine Cavern"]);
	text = gsub(text, "#cas89#", AL["The Violet Eye"]);
	text = gsub(text, "#cas90#", AL["The Botanica"]);
	text = gsub(text, "#cas91#", AL["Innervate Staff"]);
	text = gsub(text, "#cas92#", AL["Increases Innervate's Mana Regen"]);
	text = gsub(text, "#cas93#", AL["Kurenai"]);
	text = gsub(text, "#cas94#", AL["The Mag'har"]);
	text = gsub(text, "#cas95#", AL["The Consortium"]);
	text = gsub(text, "#cas96#", AL["Caverns of Time 2 (Heroic)"]);
	text = gsub(text, "#cas97#", AL["Fury Spec Weapons"]);
	text = gsub(text, "#cas98#", AL["Sethekk Halls (Heroic)"]);
	text = gsub(text, "#cas99#", AL["Horde only"]);
	text = gsub(text, "#cas100#", AL["Alliance only"]);
	text = gsub(text, "#cas101#", AL["The Shattered Halls (Heroic)"]);
	text = gsub(text, "#cas102#", AL["1h + Shield"]);
	text = gsub(text, "#cas103#", AL["For Defensive Stance"]);
	text = gsub(text, "#cas104#", AL["Magtheridon"]);
	text = gsub(text, "#cas105#", AL["Gruul's Lair"]);

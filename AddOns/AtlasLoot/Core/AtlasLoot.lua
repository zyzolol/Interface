--[[
AtlasLoot Corecraft 2.0.3
Author Protcow
Loot browser associating loot with instance bosses (2.0.3 Content)
...
ATLASLOOT_VERSION = "|cffFF8400AtlasLoot Corecraft v"..VERSION_MAJOR.."."..VERSION_MINOR.."."..VERSION_BOSSES.."|r";
ATLASLOOT_CURRENT_ATLAS = "1.0.0";
...
StaticPopupDialogs["ATLASLOOT_SETUP"] = {
  text = AL["Welcome to Atlasloot Corecraft.  Please take a moment to set your preferences."].."\n\n"..AL["This add-on is based on the 2.0.3 content."].."",
  button1 = AL["Setup"],
  OnAccept = function()
	  AtlasLootOptions_Toggle();
  end,
...
function AtlasLoot_GetLODModule(dataSource)
	...
	elseif (dataSource=="AtlasLootBiSGear") then
		return "AtlasLoot_BiSGear";
	end
end
...
function AtlasLoot_LoadAllModules()
	...
	if not AtlasLoot_Data["AtlasLootBiSGear"] then
		LoadAddOn("AtlasLoot_BiSGear");
		flag=1;
	end
...
DEFAULT_CHAT_FRAME:AddMessage("|cffFF7D0AAtlasLoot|r for Corecraft (2.0.3) updated by |cff0070DEProtcow|r \n http://www.youtube.com/Protcow");

...
if (GerNumPartyMembers() > nil) and (GetNumRaidMembers()  > nil) then 

local PARTYSapped = CreateFrame("Frame")

PARTYSapped:SetScript("OnEvent",function()
	...
	elseif (arg2 == "SPELL_AURA_APPLIED" and (arg9 == 18469 or arg9 == 15487 or arg9 == 34490 or arg9 == 41084 or arg9 == 19244 or arg9 == 19647 or arg9 == 30849) and arg7 == UnitName("player")) then
		SendChatMessage("Silenced", "PARTY") -- silence mage priest hunter lock

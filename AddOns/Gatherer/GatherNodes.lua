--[[
	...
	Revision: $Id: GatherNodes.lua 725 2008-04-08 19:23:48Z Esamynn $
...
elseif (region == "frFR") then
	Gatherer.Nodes.Names = {
		...
		["Coffre cerclé de fer"] = 181802, -- Adamantite Bound Chest
		...
		["Coffre cerclé d'adamantite"] = 184936, -- Bound Adamantite Chest
		["Oeuf de l'Aile-du-Néant (Escarpement de l'Aile-du-Néant)"] = 185915, -- Netherwing Egg
		["Fleur-de-chant purifiée"] = 164882, -- Cleansed Songflower
	}
elseif (region == "deDE") then
	Gatherer.Nodes.Names = {
		["Kleines Thoriumvorkommen"] = 324, -- Small Thorium Vein
		["Pyrophor-Mineralvorkommen"] = 1610, -- Incendicite Mineral Vein
		...
		["Indurium-Mineralvorkommen"] = 19903, -- Indurium Mineral Vein
		...
		["Bukanier-Geldkassette"] = 123330, -- Buccaneer's Strongbox
...
elseif (region == "esES") then
	Gatherer.Nodes.Names = {
		...
		["Vibrisa de Khadgar"] = 2043, -- Khadgar's Whisker
		...
		["Cofre de la Horda"] = 2844, -- Tattered Chest
		["Cofre de la Alianza"] = 2844, -- Tattered Chest
		["Cofre macizo"] = 2850, -- Solid Chest
		["Barril de Agua"] = 3658, -- Water Barrel
		["Barrica de Agua"] = 3658, -- Water Barrel
		["Barril de zumo de melón"] = 3659, -- Barrel of Melon Juice
		...
		["Barril de leche"] = 3705, -- Barrel of Milk
		["Barrica de leche"] = 3705, -- Barrel of Milk
		["Barril de néctar dulce"] = 3706, -- Barrel of Sweet Nectar
		...
		["Cajón de provisiones de la Horda"] = 142191, -- Horde Supply Crate
		...
		["Pechera de adamantita vinculada"] = 181802, -- Adamantite Bound Chest
...
elseif (region == "zhTW") then
	Gatherer.Nodes.Names = {
		...
		["艾曼泰礦床"] = 181556, -- Adamantite Deposit
		["克銀礦脈"] = 181557, -- Khorium Vein
		["可利安礦脈"] = 181557, -- Khorium Vein
		["豐沃的堅鋼礦床"] = 181569, -- Rich Adamantite Deposit
		["豐沃的艾曼泰礦床"] = 181569, -- Rich Adamantite Deposit
		...
		["破碎的提箱"] = 179486, -- Battered Footlocker
		["破碎的箱子"] = 179486, -- Battered Footlocker
		["浸水的提箱"] = 179487, -- Waterlogged Footlocker
